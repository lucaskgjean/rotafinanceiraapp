          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-3 gap-2">
                <button 
                    ...
                    className={`py-2 text-[10px] font-bold rounded-lg border transition ${paymentMethod === 'money' ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-slate-50 border-slate-200 text-slate-500'}`}
                >
                    Dinheiro
                </button>
                <button 
                    ...
                    className={`py-2 text-[10px] font-bold rounded-lg border transition ${paymentMethod === 'card' ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-slate-50 border-slate-200 text-slate-500'}`}
                >
                    Cartão
                </button>
                <button 
                    ...
                    className={`py-2 text-[10px] font-bold rounded-lg border transition ${paymentMethod === 'pix' ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-slate-50 border-slate-200 text-slate-500'}`}
                >
                    PIX
                </button>
            </div>
